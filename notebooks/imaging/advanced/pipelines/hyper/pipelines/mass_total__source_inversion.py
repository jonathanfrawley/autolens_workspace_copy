...
def make_pipeline(setup, settings):
    ...
    phase4 = phase4.extend_with_hyper_phase(
        setup_hyper=al.SetupHyper(), include_hyper_image_sky=True
    )
    ...
    phase5 = al.PhaseImaging(
        ...
        hyper_image_sky=phase4.result.hyper.model.optional.hyper_image_sky,
        hyper_background_noise=phase4.result.hyper.model.optional.hyper_background_noise,
        settings=settings,
    )
