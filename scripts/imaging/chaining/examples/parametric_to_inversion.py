...
The setting below leads to the following behaviour for searches 1 and 2:
 ...
 Search 1) No positions are input into the `AnalysisImaging`, therefore positions are not used.

 Search 2) Positions are again not manually input in the `AnalysisImaging` object. However, because the result of
