...
"""
Set up the `SettingsPhaseInterferometer` we will use to perform every model-fit of the sensitivity mapping.
"""
...
result = search.run(dataset=interferometer, mask=visibilities_mask)
...
from autolens.pipeline.search.interferometer import analysis as a
