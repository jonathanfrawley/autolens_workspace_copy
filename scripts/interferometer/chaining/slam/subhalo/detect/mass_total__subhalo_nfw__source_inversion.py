...
path_prefix = path.join(
    "interferometer", "slam", "light_parametric__mass_total__source_parametric"
)
...
In this example it:
 ...
 - Uses an `EllipticalIsothermal` model for the lens's total mass distribution [fixed from SOURCE INVERSION PIPELINE].
