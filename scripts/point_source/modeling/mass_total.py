...
The `name` and `path_prefix` below specify the path where results ae stored in the output folder:  
 ...
 `/autolens_workspace/output/ppoint_source/mass_sie__source_sersic/mass[sie]_source[point]`.
"""
...
Checkout the folder `autolens_workspace/output/point_source/mass_sie__source_point/mass[sie]_source[point]` for 
