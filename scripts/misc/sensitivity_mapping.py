...
You will note the following 4 model-fits have been performed:
 ...
 - The `base_model` + `pertubation_model` is fitted to a simulated dataset where a subhalo with `mass_at_200=1e6` 
 is included.

 - The `base_model` is fitted to a simulated dataset where a subhalo with `mass_at_200=1e11` is included.

 - The `base_model` + `pertubation_model` is fitted to a simulated dataset where a subhalo with `mass_at_200=1e11` is 
 included.
