...
def detection_single_plane(
    ...
    subhalo_mass: af.Model(al.mp.MassProfile) = af.Model(al.mp.SphericalNFWMCRLudlow),
...
def sensitivity_mapping_interferometer(
    path_prefix: str,
    uv_wavelengths : np.ndarray, real_space_mask : al.Mask2D, visibilities_mask : np.ndarray,
    mass_results,
    analysis_cls,
    subhalo_mass: af.Model(al.mp.MassProfile) = af.Model(al.mp.SphericalNFWMCRLudlow),
    grid_dimension_arcsec: float = 3.0,
